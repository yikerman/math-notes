...
\begin{definition}{Vector function}{vec-func}
  $\mathbf{r}(t) =
    \begin{pmatrix}
      x(t) \\ y(t) \\ z(t)
    \end{pmatrix}
...
\begin{example}
  $\mathbf{r}(t) =
    \begin{pmatrix}
      \dfrac{5+t^{2}}{5-t^{2}} \\[6pt] t\arctan t \\[6pt] \dfrac{5-e^{2t}}{t}
    \end{pmatrix}
  $
...
\begin{example}
  \[
    ...
    =
    \begin{pmatrix}
      \frac{1}{2}t^{2} \\[4pt] \frac{1}{2}e^{2t} \\[4pt] \frac{1}{3}t^{3}
    \end{pmatrix}
    \Bigg|_{0}^{1}
    =
    \begin{pmatrix}
      \frac{1}{2} \\[4pt] \frac{1}{2}(e^{2}-1) \\[4pt] \frac{1}{3}
    \end{pmatrix}
  \]
\end{example}
...
\begin{definition}{Arc length}{arc-length}
  \[
...
\begin{example}[Helix with unit speed]
  $\mathbf{r}(t)
    =
    \begin{pmatrix}
      \sin(t/\!\sqrt{2}) \\ \cos(t/\!\sqrt{2}) \\ t/\!\sqrt{2}
    \end{pmatrix}
  $, \quad
  $\mathbf{r}'
    = \dfrac{1}{\sqrt{2}}
    \begin{pmatrix}
      \cos(t/\!\sqrt{2}) \\ -\sin(t/\!\sqrt{2}) \\ 1
    \end{pmatrix}
  $
...
\[
  ...
  = \left\lVert\frac{d}{ds}\!\left(\frac{\mathbf{r}'(t)}{v(t)}\right)\right\rVert
