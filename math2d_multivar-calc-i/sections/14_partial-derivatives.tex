...
\begin{align*}
    ...
    &= 2(4t+3\sqrt{t})\cdot 2 + 3(2t)\cdot\tfrac{1}{2}t^{-1/2} \\
    &= 2(4t+3-3\sqrt{t})-3\sqrt{t} \\
    &= 6+8t-9\sqrt{t}
\end{align*}
\end{example}
...
\begin{example}[Minimum distance from a cylinder to a point]
Minimize the distance from a point on $x^{2}+y=7$ to $(2,0)$.
...
Find the absolute max/min of $f(x,y)=2xy-3xy$ on $0\le x,y\le 1$.
