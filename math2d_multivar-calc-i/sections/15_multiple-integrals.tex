...
The inner integral is difficult to evaluate directly, so we use Fubini's theorem to switch the order of integration.
...
\begin{theorem}[Change to Polar Coordinates]
\[
    \iint_D f\dd{A}
