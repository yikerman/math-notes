...
\begin{definition}{Spherical Coordinates}{spherical-coord}
  Spherical coordinates $(\rho, \theta, \varphi)$ (radius, azimuth, polar angle from $+z$). Conversion formulas ($r = \sqrt{x^2+y^2} = \rho\sin\varphi$ is the distance to the $z$-axis):
  \begin{align*}
