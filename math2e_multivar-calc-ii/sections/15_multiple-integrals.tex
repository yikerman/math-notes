...
Spheres have more rotational symmetry --- use spherical coordinates $(\rho, \theta, \varphi)$ (radius, longitude, latitude).
...
Conversion formulas ($r = \sqrt{x^2+y^2} = \rho\sin\varphi$ is the distance to the $z$-axis):
\begin{align*}
